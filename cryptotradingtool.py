...
host = "https://api.kraken.com/0/public/OHLC"

# https://api.kraken.com/0/public/OHLC?pair=ALGOUSD&interval=60&since=1635696000

# https://api.kraken.com/0/public/OHLC?pair=ALGOUSD&interval=3600&since=1634313600
...
# Constants
interval_param = "&interval=" + interval
since_param = "&since=" + since
pair_param = "?pair=" + pair
request_string = host + pair_param + interval_param + since_param
print(request_string)
api_request = requests.get(request_string)

loaded = api_request.json()
symbol = pair

values = []

for i in loaded["result"][symbol]:
